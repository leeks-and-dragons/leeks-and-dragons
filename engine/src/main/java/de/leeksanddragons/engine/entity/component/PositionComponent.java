...
import de.leeksanddragons.engine.json.JSONLoadable;
import de.leeksanddragons.engine.json.JSONSerializable;
...
public class PositionComponent extends BaseComponent implements JSONSerializable, JSONLoadable, Cloneable {
    ...
    protected void notifyPositionChangedListener(float oldX, float oldY, float newX, float newY) {
        ...
        /*
         * try { //lock list to avoid ConcurrentModificationException
         * this.listenerLock.tryLock(LOCK_TIMEOUT, TimeUnit.MILLISECONDS); }
         * catch (InterruptedException e) { e.printStackTrace(); throw new
         * RuntimeException("Couldnt lock changedListenerList on PositionComponent: "
    ...
    public void addPositionChangedListener(PositionChangedListener listener) {
        try {
            ...
            throw new RuntimeException(
                    "Couldnt lock changedListenerList on PositionComponent: " + e.getLocalizedMessage());
        }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof PositionComponent)) {
            ...
            // throw new IllegalArgumentException("object has to be an instance
            // of PositionComponent to check, if equals, class of object: " +
