...
public class Entity {
    ...
    protected ECSUpdatePriority updateOrder = ECSUpdatePriority.NORMAL;
    protected ECSUpdatePriority drawOrder = ECSUpdatePriority.NORMAL;
    protected ECSUpdatePriority drawUILayerOrder = ECSUpdatePriority.NORMAL;
     ...
     *            The ECS.
     */
    public void init(IScreenGame game, EntityManager ecs) {
        this.game = game;
        this.ecs = ecs;
    ...
    public void draw(IScreenGame game, GameTime time, SpriteBatch batch) {
        ...
        for (IDrawComponent component : this.drawComponentList) {
            component.draw(game, time, batch);
        }
    ...
    public void drawUILayer(IScreenGame game, GameTime time, SpriteBatch batch) {
        ...
        for (IDrawUILayerComponent component : this.drawUILayerComponentList) {
            component.drawUILayer(game, time, batch);
        }
    ...
    public void setUpdateOrder(ECSUpdatePriority updateOrder) {
    ...
    public ECSUpdatePriority getDrawOrder() {
        return this.drawOrder;
    }

    public void setDrawOrder(ECSUpdatePriority drawOrder) {
    ...
    public ECSUpdatePriority getUILayerDrawOrder() {
        return this.drawUILayerOrder;
    }

    public void setUILayerDrawOrder(ECSUpdatePriority drawOrder) {
